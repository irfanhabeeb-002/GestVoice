...
# Platform-specific imports for volume and brightness (Windows-only by default)
if sys.platform == "win32":
    ...
    sbcontrol = None  # Not available on macOS
    AudioUtilities = IAudioEndpointVolume = CLSCTX_ALL = cast = POINTER = None
    ...
    def set_finger_state(self):
        ...
        for idx,point in enumerate(points):
            ...
            try:
                ...
                ratio = 0.0  # Finger considered closed when dist2 is zero
...
class Controller:
    ...
    def changesystembrightness():
        ...
        if sys.platform == "win32" and sbcontrol is not None:
            ...
            # macOS: simulate brightness keys via AppleScript (key 144=up, 145=down)
            key_code = 144 if Controller.pinchlv > 0 else 145
            presses = min(5, max(1, int(abs(Controller.pinchlv)) + 1))
    ...
    def changesystemvolume():
        ...
        if sys.platform == "win32":
            ...
            # macOS: use osascript for volume control (0-100 scale)
            ...
            try:
                ...
                current = 50
            delta = int(Controller.pinchlv * 2)  # Scale pinch to volume steps
